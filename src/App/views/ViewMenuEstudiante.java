 ...
 * @author juans
 */
public class ViewMenuEstudiante extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ViewMenuEstudiante.class.getName());

    /**
     * Creates new form ViewMenuEstudiante
     */
    public ViewMenuEstudiante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewMenuEstudiante().setVisible(true));
    }
